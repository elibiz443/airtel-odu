  ...
  <div class="w-[90%] mx-auto">
    <div class="grid gap-6 rounded-[2.5rem] border border-slate-100 bg-white p-8 shadow-lg shadow-gray-500 lg:grid-cols-[1fr_auto] lg:items-center">
      ...
      <div class="flex flex-col gap-3 sm:flex-row lg:flex-col">
        <a href="https://wa.me/+254 103 338 353" target="_blank" rel="noopener noreferrer" class="inline-flex items-center justify-center gap-3 rounded-2xl bg-[#25D366] px-8 py-4 text-base font-bold text-white shadow-xl shadow-emerald-500/20 transition hover:bg-[#22c35e] hover:-translate-y-0.5">
