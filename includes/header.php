<header id="main-header" class="sticky top-0 z-50 border-b border-slate-200 bg-white/90 backdrop-blur transition-all duration-300">
  <div id="header-container" class="mx-auto flex max-w-7xl items-center justify-between px-4 py-4 sm:px-6 lg:px-8 transition-all duration-500">
    <a href="<?php echo ROOT_URL; ?>" class="flex items-center gap-3 hover:scale-105 transition-all duration-500">
      <div id="logo-box" class="h-11 w-11 rounded-lg border-2 border-[#E4002B] shadow-md shadow-gray-400 flex items-center justify-center">
        <img src="<?php echo ROOT_URL; ?>/assets/images/favicon.webp" class="w-[80%] h-auto">
      </div>
      <div id="logo-text" class="transition-all duration-300">
        <p class="text-md font-semibold uppercase tracking-[0.3em] text-[#E4002B]">Airtel ODU Shop</p>
        <p class="text-xs text-slate-500">Fast installation. Simple request flow.</p>
      </div>
    </a>
